...
if( ! class_exists('acf_field_taxonomy2') ) :

class acf_field_taxonomy2 extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		add_action('wp_ajax_acf/fields/taxonomy2/query',			array($this, 'ajax_query2'));
		add_action('wp_ajax_nopriv_acf/fields/taxonomy2/query',	array($this, 'ajax_query'));
		add_action('wp_ajax_acf/fields/taxonomy2/add_term',		array($this, 'ajax_add_term'));
