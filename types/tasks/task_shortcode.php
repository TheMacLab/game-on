...
<?php
	...
	<?php
					...
					// Accepted
					case 2: 
						echo '<div id="go_content">'. do_shortcode(wpautop($accpt_mssg)).'<button id="go_button" status="3" onclick="task_stage_change(jQuery(this));this.disabled=true;">'.go_return_options('go_third_stage_button').'</button><button id="go_back_button" onclick="task_stage_change(jQuery(this));this.disabled=true;" undo="true">Undo</button></div>';
					break;
					
					// Completed
					case 3: 
						echo '<div id="go_content">'. do_shortcode(wpautop($accpt_mssg)).''.do_shortcode(wpautop($completion_message)).'<button id="go_button" status="4" onclick="task_stage_change(jQuery(this));this.disabled=true;">'.go_return_options('go_fourth_stage_button').'</button><button id="go_back_button" onclick="task_stage_change(jQuery(this));this.disabled=true;" undo="true">Undo</button></div>';
					break;
...
function task_change_stage(){
	...
	switch($status) {
		...
		case 2:
			echo '<div id="new_content"><div id="prev_content">'.do_shortcode(wpautop($accpt_mssg, false)).
			'<button id="go_button" status="3" onclick="task_stage_change(jQuery(this));this.disabled=true;">'
			.go_return_options('go_third_stage_button').'</button><button id="go_back_button" onclick="task_stage_change(jQuery(this));this.disabled=true;" undo="true">Undo</button></div></div>';
			break;
		case 3:
			echo do_shortcode(wpautop($accpt_mssg, false)).'<div id="new_content"><div id="prev_content">'
			.do_shortcode(wpautop($completion_message)).
			'<button id="go_button" status="4" onclick="task_stage_change(jQuery(this));this.disabled=true;">'
			.go_return_options('go_fourth_stage_button').'</button><button id="go_back_button" onclick="task_stage_change(jQuery(this));this.disabled=true;" undo="true">Undo</button></div></div>';
			break;
		case 4:
