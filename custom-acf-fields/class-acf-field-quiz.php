	...
	function render_field( $field ) {
		...
		if ($prefix != 'acfcloneidex') {
            ...
            <table id='go_test_field_table_<?php echo $ttc; ?>' class='go_test_field_table'>
                ...
                if (!empty($test_field_block_count) && !empty($test_field_input_array)) {
					...
					<tr id='go_test_field_input_row_{$ttc}_{$i}' class='go_test_field_input_row_{$ttc} go_test_field_input_row'>
						<td>
							<select class='go_test_field_select_{$ttc}_{$i}' class='go_test_field_input_select_{$ttc}' name='go_test_field_select_{$ttc}[]' onchange='update_checkbox_type_{$ttc}(this);'>
                            ...
                            if (!empty($test_field_input_question)) {
                                echo "<br/><br/><input class='go_test_field_input_question_{$ttc} go_test_field_input_question  noEnterSubmit' name='go_test_field_input_question_{$ttc}[]' placeholder='Shall We Play a Game?' type='textarea' value=\"" . htmlspecialchars($test_field_input_question[$i], ENT_QUOTES) . "\" />";
                            } else {
                                echo "<br/><br/><input class='go_test_field_input_question_{$ttc} go_test_field_input_question noEnterSubmit' name='go_test_field_input_question_{$ttc}[]' placeholder='Shall We Play a Game?' type='textarea' />";
                            }
                            if (!empty($test_field_input_count)) {
								...
								<input class='go_test_field_input_checkbox_hidden_{$ttc} noEnterSubmit' name='go_test_field_values_{$ttc}[{$i}][1][]' type='hidden' />
								<input class='go_test_field_input_{$ttc} go_test_field_input noEnterSubmit' name='go_test_field_values_{$ttc}[{$i}][0][]' placeholder='Enter an answer!' type='text' value=\"" . htmlspecialchars($test_field_input_array[$i][0][$x], ENT_QUOTES) . "\" oninput='update_checkbox_value_{$ttc}(this);' oncut='update_checkbox_value_{$ttc}(this);' onpaste='update_checkbox_value_{$ttc}(this);' />";
                                    if ($x > 1) {
                                        echo "<input class='go_button_del_field go_test_field_rm go_test_field_rm_input_button_{$ttc} noEnterSubmit' type='button' value='x' onclick='remove_field_{$ttc}(this);'>";
                                    }
                                    echo "</li>";
                                    if (($x + 1) == $test_field_input_count[$i]) {
                                        echo "<input class='go_button_add_field go_test_field_add go_test_field_add_input_button_{$ttc} noEnterSubmit' type='button' value='+' onclick='add_field_{$ttc}(this);'/>";
                                    }
                                }
                                echo "</ul><ul>";
                                if ($i > 0) {
                                    echo "<li><input class='go_button_del_field go_test_field_rm_row_button_{$ttc} go_test_field_input_rm_row_button  noEnterSubmit' type='button' value='Remove Question' onclick='remove_block_{$ttc}(this);' /></li>";
                                }
                                echo "<li><input class='go_test_field_input_count_{$ttc} noEnterSubmit' name='go_test_field_input_count_{$ttc}[]' type='hidden' value='{$test_field_input_count[ $i]}' /></li></ul>";
                            } else {
                                echo "
						<ul>
							<li><input class='go_test_field_input_checkbox_{$ttc} go_test_field_input_checkbox noEnterSubmit' name='go_test_field_input_checkbox_{$ttc}_{$i}' type='{$test_field_select_array[ $i]}' onchange='update_checkbox_value_{$ttc}(this);' /><input class='go_test_field_input_checkbox_hidden_{$ttc}' name='go_test_field_values_{$ttc}[{$i}][1][]' type='hidden' /><input class='go_test_field_input_{$ttc} go_test_field_input' name='go_test_field_values_{$ttc}[{$i}][0][]' placeholder='Enter an answer!' type='text' value=\"" . htmlspecialchars($test_field_input_array[$i][0][0], ENT_QUOTES) . "\" oninput='update_checkbox_value_{$ttc}(this);' oncut='update_checkbox_value_{$ttc}(this);' onpaste='update_checkbox_value_{$ttc}(this);' /></li>
							<li><input class='go_test_field_input_checkbox_{$ttc} go_test_field_input_checkbox noEnterSubmit' name='go_test_field_input_checkbox_{$ttc}_{$i}' type='{$test_field_select_array[ $i]}' onchange='update_checkbox_value_{$ttc}(this);' /><input class='go_test_field_input_checkbox_hidden_{$ttc}' name='go_test_field_values_{$ttc}[{$i}][1][]' type='hidden' /><input class='go_test_field_input_{$ttc} go_test_field_input' name='go_test_field_values_{$ttc}[{$i}][0][]' placeholder='Enter an answer!' type='text' value=\"" . htmlspecialchars($test_field_input_array[$i][0][1], ENT_QUOTES) . "\" oninput='update_checkbox_value_{$ttc}(this);' oncut='update_checkbox_value_{$ttc}(this);' onpaste='update_checkbox_value_{$ttc}(this);' /></li>";
                                echo "</ul><ul><li>";
                                if ($i > 0) {
                                    echo "<input class='go_button_del_field go_test_field_rm_row_button_{$ttc} go_test_field_input_rm_row_button noEnterSubmit' type='button' value='Remove Question' onclick='remove_block_{$ttc}(this);' /></li><li>";
                                }
                                echo "<input class='go_test_field_input_count_{$ttc} noEnterSubmit' name='go_test_field_input_count_{$ttc}[]' type='hidden' value='2' /></li></ul>";
                            }
                            echo "
						</td>
					</tr>";
				...
				<tr id='go_test_field_input_row_{$ttc}_0' class='go_test_field_input_row_{$ttc} go_test_field_input_row'>
					<td>
						<select class='go_test_field_select_{$ttc}_0' class='go_test_field_input_select_{$ttc}' name='go_test_field_select_{$ttc}[]' onchange='update_checkbox_type_{$ttc}(this);'>
						...
						<br/><br/>
						<input class='go_test_field_input_question_{$ttc} go_test_field_input_question noEnterSubmit' name='go_test_field_input_question_{$ttc}[]' placeholder='Shall We Play a Game?' type='text' />
						<ul>
							<li>
								<input class='go_test_field_input_checkbox_{$ttc} go_test_field_input_checkbox noEnterSubmit' name='unused_go_test_field_input_checkbox_{$ttc}_0' type='radio' onchange='update_checkbox_value_{$ttc}(this);' />
								<input class='go_test_field_input_checkbox_hidden_{$ttc} noEnterSubmit' name='go_test_field_values_{$ttc}[0][1][]' type='hidden' />
								<input class='go_test_field_input_{$ttc} go_test_field_input noEnterSubmit' name='go_test_field_values_{$ttc}[0][0][]' placeholder='Yes' type='text' oninput='update_checkbox_value_{$ttc}(this);' oncut='update_checkbox_value_{$ttc}(this);' onpaste='update_checkbox_value_{$ttc}(this);' />
							</li>
							<li>
								<input class='go_test_field_input_checkbox_{$ttc} go_test_field_input_checkbox noEnterSubmit' name='unused_go_test_field_input_checkbox_{$ttc}_0' type='radio' onchange='update_checkbox_value_{$ttc}(this);' />
								<input class='go_test_field_input_checkbox_hidden_{$ttc} noEnterSubmit' name='go_test_field_values_{$ttc}[0][1][]' type='hidden' />
								<input class='go_test_field_input_{$ttc} go_test_field_input noEnterSubmit' name='go_test_field_values_{$ttc}[0][0][]' placeholder='No' type='text' oninput='update_checkbox_value_{$ttc}(this);' oncut='update_checkbox_value_{$ttc}(this);' onpaste='update_checkbox_value_{$ttc}(this);' />
							</li>
							<input class='go_button_add_field go_test_field_add go_test_field_add_input_button_{$ttc} noEnterSubmit' type='button' value='+' onclick='add_field_{$ttc}(this);'/>
						</ul>
						<ul>
							<li>
								<input class='go_test_field_input_count_{$ttc} noEnterSubmit' name='go_test_field_input_count_{$ttc}[]' type='hidden' value='2' />
							</li>
						</ul>
					</td>
				</tr>
			";
                ...
                <tr>
                    <td>
                        <input class='go_test_field_add_block_button_<?php echo $ttc; ?>'
                               class='go_button_add_field go_test_field_add_block_button noEnterSubmit' value='Add Question'
                               type='button' onclick='add_block_<?php echo $ttc; ?>(this);'/>
                        <?php
                        if (!empty($test_field_block_count)) {
                            echo "<input class='go_test_field_block_count_{$ttc} noEnterSubmit' name='go_test_field_block_count_{$ttc}' type='hidden' value='{$test_field_block_count}' />";
                        } else {
                            echo "<input class='go_test_field_block_count_{$ttc} noEnterSubmit' name='go_test_field_block_count_{$ttc}' type='hidden' value='1' />";
                        }
                        ?>
                    </td>
                </tr>
                    ...
                    if (!empty($test_field_block_count)) {
                        for ($i = 0; $i < $test_field_block_count; $i++) {
                            if (!empty($test_field_select_array[$i])) {
                                ...
                                if (($i + 1) !== $test_field_block_count && !empty($test_field_select_array[$i + 1])) {
                                    echo ', ';
                                }
                            }
                        }
