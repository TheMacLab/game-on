...
<th class="header" style="width:13%;"><a href="#" ><?php echo go_return_options('go_infractions_name'); ?><br> (Max: <?php echo go_return_options('go_max_infractions'); ?>)</a></th>
