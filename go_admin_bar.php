...
if (!is_admin_bar_showing() || !is_user_logged_in() )
	return;
	$wp_admin_bar->add_menu( array(
		'title' => '<div style="padding-top:5px;"><div id="go_admin_bar_hitpoint_bar_border"><div id="user_hp" class="go_admin_bar_text">'.go_return_options('go_infractions_name').': '.$current_user_infractions.'/'.$current_max_infractions.' </div><div id="go_hp_bar" class="progress_bar" style="width:100%; background-color: '.$htpt_color.' ;"></div></div></div>',
		'href' => '#',
		'parent' => 'go_info',
	));
