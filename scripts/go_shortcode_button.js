	...
	tinymce.PluginManager.add('go_shortcode_button', function( editor, url ) {
		editor.addButton( 'go_shortcode_button', {
			...
			menu: [
				...
				{text: "[go_display_video video_url='' video_title='' width='' height='']", onclick: function() {editor.insertContent("[go_display_video video_url='' video_title='' width='' height='']");}}, 
				...
				{text: '[go_loginname]', onclick: function() {editor.insertContent('[go_lastname]');}}, 
			],
		});
	});
})();