...
function go_add_post ($user_id, $post_id, $status, $points, $currency, $bonus_currency = null, $minutes = null, $page_id, $repeat = null, $count = null, $e_fail_count = null, $a_fail_count = null, $c_fail_count = null, $m_fail_count = null, $e_passed = null, $a_passed = null, $c_passed = null, $m_passed = null, $url = null, $reason = null, $bonus_loot = false) {
	global $wpdb;
	$table_name_go = $wpdb->prefix . "go";
	...
	if ($status === -1) {
		$qty = ($bonus_loot == false) ? $_POST['qty'] : 1;
	...
	go_update_totals($user_id, $points, $currency, $bonus_currency, 0, $minutes, $status, $bonus_loot);
}
...
function go_notify ($type, $points = '', $currency = '', $bonus_currency = '', $penalty = '', $minutes = '', $user_id = null, $display = null, $bonus_loot = false) {
	if ($user_id != get_current_user_id()) {
		...
		if ($points < 0 || $currency < 0 || $bonus_currency < 0 || $minutes < 0) {
			...
			$sym = '+';
			$background = ($bonus_loot == false) ? "#39b54a" : "#1E90FF";
		} else if ($penalty > 0) {
			$sym = '-';
			$background = "#ff0000";
		} else if ($bonus_loot == true) {
			$background = "#1E90FF";
		} else {
			$sym = '+';
			$background = "#39b54a";
...
//Update totals
function go_update_totals ($user_id, $points, $currency, $bonus_currency, $penalty, $minutes, $status = null, $bonus_loot = false){
	global $wpdb;
