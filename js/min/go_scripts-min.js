...
if(1==jQuery(this).hasClass("size-full"))var t=jQuery(this).attr("src");else var a,s=/.*wp-image/,o=jQuery(this).attr("class").replace(s,"wp-image"),r=jQuery(this).attr("src"),i=/-([^-]+).$/,_=/\.[0-9a-z]+$/i,n=r.match(_),t=r.replace(i,n);
//console.log(class1);
...
var i=jQuery(".go_checkbox:visible"),_=0;_<i.length;_++)if(!0===i[_].checked){var n=i[_].getAttribute("data-uid"),l=i[_].getAttribute("data-task");"multiple_messages"==s&&(l=""),a.push({uid:n,task:l})}}else"single_reset"!=s&&"single_message"!=s||//single task reset or message was pressed
a.push({uid:e,task:t});
...
jQuery(document).ready(function(){jQuery(".go_str_item").one("click",function(e){go_lb_opener(this.id)})}),function(i){"use strict";i.fn.fitVids=function(e){var a={customSelector:null,ignore:null};if(!document.getElementById("fit-vids-style")){
...
i.fn.fitVids._count=0}(window.jQuery||window.Zepto),jQuery(window).ready(function(){
