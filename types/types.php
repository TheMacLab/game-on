...
function go_store_exchange() {
	...
	echo "
		<input id='go_store_exchange_checkbox' name='go_mta_store_exchange' type='checkbox' {$is_checked}/>
...
function go_validate_store_exchange() {
	...
	$c_exchange = ( ! empty( $_POST['go_store_exchange_currency'] )       ? (int) $_POST['go_store_exchange_currency'] : 0 );
	$p_exchange = ( ! empty( $_POST['go_store_exchange_points'] )         ? (int) $_POST['go_store_exchange_points'] : 0 );
	$b_exchange = ( ! empty( $_POST['go_store_exchange_bonus_currency'] ) ? (int) $_POST['go_store_exchange_bonus_currency'] : 0 );
	$t_exchange = ( ! empty( $_POST['go_store_exchange_time'] )           ? (int) $_POST['go_store_exchange_time'] : 0 );
