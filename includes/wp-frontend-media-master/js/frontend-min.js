...
var i="Select a file.",n;0!=e.length&&(i=i+" File type required: "+e.replace(/,/g,", ")+".");
// Add page slug to media uploader settings
_wpPluploadSettings.defaults.multipart_params.admin_page="gif",
//if the file_frame has already been created, just reuse it
l||(l=wp.media.frames.file_frame=wp.media({title:i,button:{text:"Select"},multiple:!1,// set this to true for multiple file selection
