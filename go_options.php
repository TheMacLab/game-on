...
?>  
    ...
    <div class="light">
        <div style="margin: 10px 10px 10px 10px; width: 864px; height: 540px;">
        	<video id="go_option_help_video" class="video-js vjs-default-skin vjs-big-play-centered" controls height="100%" width="100%" ><source src="" type="video/mp4"/></video>
        </div>
    </div>
    <div class="go-wrap">  
        <h2>Game On Options </h2><?php echo 'Click ?\'s for videos.'; ?>
