...
class acf_field_taxonomy extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		add_action('wp_ajax_acf/fields/taxonomy/query2',			array($this, 'ajax_query2'));
	...
	*/
	...
	function get_ajax_query2( $options = array() ) {
		...
		/*
		// filters
		$args = apply_filters('acf/fields/taxonomy/query2', $args, $field, $options['post_id']);
		$args = apply_filters('acf/fields/taxonomy/query2/name=' . $field['name'], $args, $field, $options['post_id'] );
		$args = apply_filters('acf/fields/taxonomy/query2/key=' . $field['key'], $args, $field, $options['post_id'] );
