...
if( ! class_exists('acf_field_taxonomy1') ) :

class acf_field_taxonomy1 extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		add_action('wp_ajax_acf/fields/taxonomy1/query',			array($this, 'ajax_query2'));
		add_action('wp_ajax_nopriv_acf/fields/taxonomy1/query',	array($this, 'ajax_query'));
		add_action('wp_ajax_acf/fields/taxonomy1/add_term',		array($this, 'ajax_add_term'));
	...
	*/
	...
	function ajax_query2() {
		...
		// get choices
		$response = $this->get_ajax_query2( $_POST );
	...
	*/
	...
	function get_ajax_query2( $options = array() ) {
    	...
    	foreach ( $terms as $term ) {
             ...
             */
                        $dataPoints[] = array("children"=>$children,);
...
// initialize
acf_register_field_type( 'acf_field_taxonomy1' );

function my_taxonomy_query1( $args, $field, $post_id ) {
...
add_filter('acf/fields/taxonomy/query', 'my_taxonomy_query1', 10, 3);
