	...
	*/
	...
	if( typeof acf.add_action !== 'undefined' ) {
		...
		*/
		...
		acf.add_action('ready_field/type=CHILD_TAXONOMY_ORDER', 'initialize_field');
		acf.add_action('append_field/type=CHILD_TAXONOMY_ORDER', 'initialize_field');
...
*/
		...
		*/
		...
		$(document).on('acf/setup_fields', function(e, postbox){
			...
			$(postbox).find('.field[data-field_type="CHILD_TAXONOMY_ORDER"]').each(function(){
