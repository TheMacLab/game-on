...
jQuery(document).ready(function() {
    jQuery('.select2_taxonomy').select2();
});
...
(function($) {
	...
	// taxonomy
	acf.fields.taxonomychild = acf.field.extend({
		...
		focus: function() {
			...
			// $el
			this.$el = this.$field.find('.acf-taxonomy-child-field');
		...
		append_new_term: function(term) {
			...
			$('.acf-taxonomy-child-field[data-taxonomy="' + this.o.taxonomy + '"]').each(function() {
